...
- Nowadays, many devices operations are based on digital technology like a token-based digital identity device. 
- The objective of this project in its simplest terms is to replace metallic keys by building a fully featured password enabled electronic security system prototype. 
- One such device is Password Based Door Open System Using LPC2148. 
- With this kind of entry system, people no longer have to worry about lost or stolen keys and they never have to bring keys with them everywhere they go or hide them in secret places to keep them away from the hands of unauthorized individuals. 
